...
| An unanswered audit costs the whole bond | Batch 0 went unconfirmed past the challenge window → `flagAudit` burned `deposit` **499.504 → 0** (500.000 posted, less the 0.496 the mass balance had already taken) |
